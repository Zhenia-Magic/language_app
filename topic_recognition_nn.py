...
df = pd.read_csv('voted-kaggle-dataset2.csv')

df_topic = df[["Title", "Subtitle", "Tags", "Description"]]

df_topic = df_topic.dropna().reset_index()

df_topic['Text'] = df_topic['Title']  + ' ' + df_topic['Subtitle']+ ' ' + df_topic['Description']
...
d_new.append('+ 2 more...')
d_new.append('pre-trained model')
...
filename = open("topics_vocabulary1.pkl", "wb")
...
pkl_filename = "topic_recognition_model1.pkl"
with open(pkl_filename, 'wb') as file:
